...
/**
 * Small link in the hero footer that surfaces current body weight
 * and links to full Settings page for editing bars, plates, etc.
 */
export default function BodyWeightSetting() {
  ...
  return (
    ...
    >
      ...
      {currentBw ? `Settings · ${currentBw} lbs body weight` : 'Settings'}
    </button>
  );
}
